                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <input
                                ...
                                placeholder="Crisis Advisory: Mumbai Floods"
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <div className="border border-gray-300 rounded-lg overflow-hidden">
                                ...
                                <div className="bg-gray-50 border-b border-gray-300 p-2 flex gap-2">
                                    <button className="px-3 py-1 bg-white border border-gray-300 rounded hover:bg-gray-100 text-sm font-semibold">
                                        B
                                    </button>
                                    <button className="px-3 py-1 bg-white border border-gray-300 rounded hover:bg-gray-100 text-sm italic">
                                        I
                                    </button>
                                    <button className="px-3 py-1 bg-white border border-gray-300 rounded hover:bg-gray-100 text-sm underline">
                                        U
                                    </button>
                                    <div className="w-px bg-gray-300"></div>
                                    <button className="px-3 py-1 bg-white border border-gray-300 rounded hover:bg-gray-100 text-sm">
                                        H1
                                    </button>
                                    <button className="px-3 py-1 bg-white border border-gray-300 rounded hover:bg-gray-100 text-sm">
                                        H2
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 focus:ring-0 focus:outline-none border-0 resize-none"
                                    rows={15}
